...
let selected = document.querySelector('.more')
more.addEventListener('click', () =>
{
    selected.classList.toggle('moreSelected')
})

const quitMore = document.querySelector('.moreQuit')
quitMore.addEventListener('click', () =>
{
    selected.classList.toggle('moreSelected')
})